...
public:
	...
	UPROPERTY() float AI_sense_sight_lose_sight_radius_value = 4280.0f;
	UPROPERTY() float AI_sense_sight_peripheral_vision_angle_degrees_value = 360.0f;
	UPROPERTY() float AI_sense_sight_radius_value = 4250.0f;
	UPROPERTY() float allowed_distance_without_pathfinding = 700.0f;
	...
	UPROPERTY() float movement_speed = 640.0f;
